...
public class Exc07_NumberOfWaysToSplitArray {

    public int numOfValidSplits(int[] nums) {
        int n = nums.length;
        long totalSum = 0;
        for (int num : nums) {
            totalSum += num;
    ...
    public static void main(String[] args) {
        Exc07_NumberOfWaysToSplitArray solution = new Exc07_NumberOfWaysToSplitArray();

        int[] nums1 = {10, 4, -8, 7};
        System.out.println("Number of valid splits: " + solution.numOfValidSplits(nums1));
        // Expected: 2

        int[] nums2 = {2, 3, 1, 0};
        System.out.println("Number of valid splits: " + solution.numOfValidSplits(nums2));
        // Expected: 2
    }
}
